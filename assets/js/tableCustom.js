class tableItem { 
                                    ...
                                    <div class="d-flex">   
                                        ...
                                        <div class="px-0 order-md-1 order-3"> 
                                            <div class="btn-group d-inline-block" role="group"> 
                                                ...
                                                <button class="btn btn-sm btn-danger btn-action detail p-2 py-1 rounded" data-id="${i}" data-type="delete">
    ...
    render() {
        ...
        $("#" + this.elementId + " .btn-action.detail[data-type='delete']").click(function(){
                        ...
                        html += `   <div class="row align-items-center mx-0 hr p-2">
                                        <div class="col-12 col-md-4 my-1 varian px-0">   
                                            <div class="d-flex align-items-center">
                                                <div class="px-0 order-md-1 order-4"> 
                                                    <div class="btn-group d-inline-block" role="group"> 
                                                        <button class="btn btn-sm btn-primary btn-action detail p-2 py-1 rounded" data-id="${i}" data-type="up"><i class="fa-solid fa-arrow-up"></i></button>   
                                                        <button class="btn btn-sm btn-primary btn-action detail p-2 py-1 rounded" data-id="${i}" data-type="down"><i class="fa-solid fa-arrow-down"></i></button> 
                                                    </div>
                                                </div> 
                                                <span class="no-urut text-head-3 order-md-2 order-1 p-2">${last_group_no}. </span> 
                                        ...
                                        <div class="col-12 col-md-8 my-1 detail">
                                            <div class="row px-2">  
                                                <div class="col-12 col-md-3 px-1 ">  
                                                    <span class="label-head-dialog"><span class="d-inline-block d-md-none pe-2 pt-2 float-start">Qty/Satuan</span>
                                                    <div class="input-group"> 
                                                        <input type="text" class="form-control form-control-sm input-form berat" id="input-qty-${i}" data-id="${i}" disabled> 
                                                        <span class="input-group-text font-std px-1">${this.dataitem[i]["satuan_text"]}</span> 
                                                    </div>  
                                                </div>   
                                                <div class="col-6 col-md-3 px-1">  
                                                    <span class="label-head-dialog"><span class="d-inline-block d-md-none pe-2 pt-2 float-start">Diterima</span>
                                                    <div class="input-group"> 
                                                        <input type="text"class="form-control form-control-sm  input-form d-inline-block" id="input-diterima-${i}" data-id="${i}" ${this.dataitem[i]["id"] != "0" ? "" : ""}>
                                                        <span class="input-group-text font-std px-1">${this.dataitem[i]["satuan_text"]}</span> 
                                                    </div>    
                                                </div> 
                                                <div class="col-6 col-md-3  px-1">  
                                                    ...
                                                    <div class="input-group">  
                                                        <input type="text"class="form-control form-control-sm  input-form d-inline-block hargabeli" id="input-spare-${i}" data-id="${i}">
                                                        <span class="input-group-text font-std px-1">${this.dataitem[i]["satuan_text"]}</span> 
                                                    </div>   
                                                </div> 
                                                <div class="col-6 col-md-3  px-1">  
                                                    ...
                                                    <div class="input-group"> 
                                                        <input type="text"class="form-control form-control-sm  input-form d-inline-block hargajual" id="input-rusak-${i}" data-id="${i}">
                                                        <span class="input-group-text font-std px-1">${this.dataitem[i]["satuan_text"]}</span>
                                                    </div>   
                                                </div>   
                                            </div>    
    ...
    setupDatahtml(){
        ...
        for(var i = 0; self.dataitem.length > i;i++){
            if(self.dataitem[i]["type"] == "product"){  
                ...
                if(self.dataitem[i]["satuan_id"] > 0) $(`#select-satuan-${i}`).append(new Option(self.dataitem[i]["satuan_text"] , self.dataitem[i]["satuan_id"], true, true)).trigger('change');  
                if(self.dataitem[i]["id"] === "0")  $(`#select-satuan-${i}`).prop("disabled",true)
                ...
                inputharga[i] = new Cleave(`#input-diterima-${i}`, {
                    numeral: true,
                    delimeter: ",",
                    numeralDecimalScale:0,
                    numeralThousandGroupStyle:"thousand"
                }); 
                inputdisc[i] = new Cleave(`#input-spare-${i}`, {
                    numeral: true,
                    delimeter: ",",
                    numeralDecimalScale:0,
                    numeralThousandGroupStyle:"thousand"
                }); 
                inputtotal[i] = new Cleave(`#input-rusak-${i}`, {
                    numeral: true,
                    delimeter: ",",
                    numeralDecimalScale:0,
                    numeralThousandGroupStyle:"thousand"
                ...
                inputqty[i].setRawValue(self.dataitem[i]["qty_ref"]);
                $(`#input-qty-${i}`).on("keyup",function(){ 
                    self.dataitem[$(this).data("id")]["qty_ref"] = inputqty[$(this).data("id")].getRawValue();
                    if($(`#input-qty-${i}`).val() == "") $(`#input-qty-${i}`).val(0)  
                });  
 

                //event diterima
                inputharga[i].setRawValue(self.dataitem[i]["qty"]);
                $(`#input-diterima-${i}`).on("keyup",function(){ 
                    self.dataitem[$(this).data("id")]["qty"] = inputharga[$(this).data("id")].getRawValue();
                    if($(`#input-diterima-${i}`).val() == "") $(`#input-diterima-${i}`).val(0)  
                });   

                //event spare
                inputdisc[i].setRawValue(self.dataitem[i]["qty_spare"]);
                $(`#input-spare-${i}`).on("keyup",function(){ 
                    self.dataitem[$(this).data("id")]["qty_spare"] = inputdisc[$(this).data("id")].getRawValue();
                    if($(`#input-spare-${i}`).val() == "") $(`#input-spare-${i}`).val(0)  
                });  

                //event rusak
                inputtotal[i].setRawValue(self.dataitem[i]["qty_waste"]);
                $(`#input-rusak-${i}`).on("keyup",function(){ 
                    self.dataitem[$(this).data("id")]["qty_waste"] = inputtotal[$(this).data("id")].getRawValue();
        ...
        var html = `
            ...
            <div class="card-body p-0 bg-light">
                ...
                <div class="col-12 col-md-8 my-1">
                    <div class="row">
                        <div class="col-3">
                            <span class="label-head-dialog">Qty Ref</span>
                        </div> 
                        <div class="col-3">
