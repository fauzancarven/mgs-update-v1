<!-- CUSTOMER -->
<div class="modal fade" id="modal-edit-customer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  aria-labelledby="modal-add-customer-label" aria-hidden="true" style="overflow-y:auto;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title fs-5 fw-bold" id="modal-add-customer-label">Edit Customer</h2>
            ...
            <div class="modal-footer p-2">
                ...
                <button type="button" class="btn btn-primary" id="btn-save-customer">Simpan</button>
            </div>
        </div>
    </div>
</div>
<script>
    ...
    $("#MsCustomerCategory").select2({
        ...
        dropdownParent: $('#modal-edit-customer .modal-content'),
        ajax: {
    ...
    var dataarray = <?= $_province ?>; 
    var typenavvillage = "poscode";
    var selectcity = dataarray[0]; 
