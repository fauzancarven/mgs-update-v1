...
<script>
    ...
    add_click = function(el){
        if (isProcessingPO) {
            console.log("add PO cancel load");
            return;
        }   
        isProcessingPO = true; 
    ...
    edit_pengiriman = function(id,el,ref){
        ...
        $.ajax({  
            ...
            success: function(data) {  
                ...
                $("#modal-edit-po").data("menu","Pembelian");  
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(data) { 
                        Swal.fire({
                            title: "Success!",
                            text: "Data Pembelian berhasil di batalkan.",
                            icon: "success",
                            confirmButtonColor: "#3085d6",
                        });  
                        table.ajax.reload(null, false);
