<div class="modal fade" id="modal-add-survey" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"  aria-labelledby="modal-add-project-label" aria-hidden="true" data-menu="project">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title fs-5 fw-bold" id="modal-add-project-label">Tambah Data Survey</h2>
            ...
            <div class="modal-body p-3"> 
                ...
                <div class="mb-1">
                    ...
                    <input class="form-control form-control-sm input-form" style="width:100%" id="SurveyCustName" value=""> 
                </div> 
                <div class="mb-1">
                    <label for="SurveyCustTelp" class="col-form-label">Telp PIC</label>
                    <input class="form-control form-control-sm input-form" style="width:100%" id="SurveyCustTelp" value=""> 
                </div> 
                <div class="mb-1">
                    <label for="SurveyAddress" class="col-form-label">Alamat Proyek</label>
                    <textarea class="form-control form-control-sm input-form" style="width:100%" id="SurveyAddress"></textarea> 
                </div>  
                <div class="mb-1">
            ...
            success: function(data) {    
                ...
                if(data["status"]===true){
                    Swal.fire({
                        ...
                        if( $("#modal-add-survey").data("menu") == "Survey"){ 
