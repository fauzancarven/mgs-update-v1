...
<div class="modal fade" id="modal-edit-finish-delivery" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="1"  aria-labelledby="modal-edit-delivery-label" style="overflow-y:auto;">
                ...
                <div class="row mx-2"> 
                    ...
                    <div class="col-6">  
                        <div class="row mb-1 align-items-center mt-2 px-2">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control form-control-sm input-form" id="DeliveryReceiveName" value="<?= $delivery->DeliveryReceiveName?>">
                            </div>
                        </div> 
                    </div>   
                </div>   
...
<script>
    $('#DeliveryDateFinish').daterangepicker({
        ...
        "startDate": moment('<?= $delivery->DeliveryDateFinish ?>'),
        "endDate":  moment('<?= $delivery->DeliveryDateFinish ?>'),
        locale: {
            format: 'DD MMMM YYYY'
        }
    });
    ...
    $("#btn-finish-delivery").click(function(){
        ...
        $.ajax({ 
            dataType: "json",
            method: "POST",
            url: "<?= base_url() ?>action/edit-finish-delivery/<?= $delivery->DeliveryId?>", 
            data:{
                "header":header,
                "detail":detail, 
            },
            success: function(data) {    
                ...
                if(data["status"]===true){
                    Swal.fire({
                        ...
                        $("#modal-edit-finish-delivery").modal("hide");   
