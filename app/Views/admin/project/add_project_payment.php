                ...
                <div class="mb-1">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group"> 
                                <span class="input-group-text font-std">Rp.</span>
                                <input type="text"class="form-control form-control-sm  input-form d-inline-block number-price" id="sisa-payment" value="<?= $project->grandtotal - (array_sum(array_column($payment, 'total'))) ?>" disabled>
                            </div>  
                        </div>
                    </div>  
                </div> 
