                    ...
                    <div class="col-lg-6 col-12 my-1 mb-2 ">
                        ...
                        <div class="customer-display card bg-light show mt-4 m-1 p-2"> 
                            <div class="row mb-1 align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input  class="form-control form-control-sm input-form" id="SampleCustName" type="text" value=""/>
                                </div>
                            </div> 
                            <div class="row mb-1 align-items-center">
                                <label for="SampleAddress" class="col-sm-3 col-form-label">Telp Customer</label>
                                <div class="col-sm-9">
                                    <input  class="form-control form-control-sm input-form" id="SampleCustTelp"  type="text" value=""/>
                                </div>
                            </div> 
                            <div class="row mb-1 align-items-center">
                                <label for="SampleAddress" class="col-sm-3 col-form-label">Alamat Project</label>
                                <div class="col-sm-9">
                                    <textarea  class="form-control form-control-sm input-form" id="SampleAddress"></textarea>
                                </div>
                            </div>  
                        </div>   
                    </div>  
...
<script>     
    ...
    $("#SampleRef").select2({
        ...
        ajax: {
            url: "<?= base_url()?>select2/get-data-ref-sample",
            dataType: 'json',
            type:"POST",
            delay: 250,
