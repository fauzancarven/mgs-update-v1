...
<head>
    <meta charset="utf-8"/>
    <title><?= 'PAY_INV_'.$project->name.'_'.$project->date ?></title>
    ...
    <div class="body">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="align-items: start;justify-content: center"> 
                        ...
                        <div class="width-label label-color d-inline-block">Tgl.</div><div class="label-color d-inline-block">&nbsp;:&nbsp;</div><div class="label-color-1 d-inline-block text-bold"><?= date_format(date_create($payment->date),"d F Y") ?></div><br> 
                    </td>
                </tr>
            </tbody>
        </table> 
        <table class="item">
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="2" style="border-left:none;line-height:1;"></td>
                    <th class="td-footer text-bold"  style="line-height:1;" colspan="<?= (array_filter($detail, fn($item) => $item->disc > 0)) ? "3" : "2" ?>"><?= "(".date_format(date_create($payment->date),"d M Y").") ".$payment->type ?></th>
                    <th class="td-center text-bold">
                        <div style="width:15%;text-align:left;display:inline-block;line-height:1;margin:0;padding:0;">Rp.</div> 
                        <div style="width:75%;text-align:right;display:inline-block;line-height:1;margin:0;padding:0;"><?= number_format($payment->total, 0, ',', '.') ?></div>
                    </th>
                </tr>  
                <tr>
                    <td colspan="2" style="border-left:none;line-height:1;"></td>
                    <th class="td-footer text-bold"  style="line-height:1;" colspan="<?= (array_filter($detail, fn($item) => $item->disc > 0)) ? "3" : "2" ?>">Sisa</th>
                    <th class="td-center text-bold">
                        <div style="width:15%;text-align:left;display:inline-block;line-height:1;margin:0;padding:0;">Rp.</div> 
                        <div style="width:75%;text-align:right;display:inline-block;line-height:1;margin:0;padding:0;"><?= number_format($project->grandtotal - $payment->total, 0, ',', '.') ?></div>
                    </th>
                </tr>  
            </tfoot>
        </table> 
