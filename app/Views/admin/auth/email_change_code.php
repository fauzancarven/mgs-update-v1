        ...
        <div class="w-100 mx-3">
          <div class="card col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 class="text-center mt-2">Kode Verifikasi Email</h4>
              <form class="pt-3" action="<?=base_url();?>changemail_code_validation" method="post">

                <p class="text-center mb-3 font-weight-light">Masukan kode verifikasi yang dikirimkan ke alamat email <strong><?=$email;?></strong></p>
