        ...
        <div class="w-100 mx-3">
          <div class="card col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="<?= base_url(); ?>email_activation" method="post">

                <p class="text-center mb-3 font-weight-light">Masukan kode verifikasi yang dikirimkan ke alamat Email <strong><?= $email; ?> </p>
