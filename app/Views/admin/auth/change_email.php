        ...
        <div class="w-100 mx-3">
          <div class="card col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 class="text-center mt-2">Ubah Email?</h4>
              <form class="pt-3" action="<?= base_url(); ?>send_changemail_code" method="post">

                <p class="text-center mb-3 font-weight-light">Kami akan mengirimkan kode untuk mengatur alamat Email baru Anda ke alamat email <br><strong><?= user()->email; ?></strong></p>
